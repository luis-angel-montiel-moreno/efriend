...
# letra= raw_input("inicia busqueda")
...
#  for j in range(0, len(lista_dict)-1): #  AGUAS 22 nov
  sel_01= random.randint(0, 3)
  if sel_01==0: return False
  sel_ran= random.randint(0, len(lista_dict)-1)
  c2=str.lower(lista_dict[sel_ran].replace("\n","")) 
#  print("cOMODIN=",c2)
  iden1.write("cOMODIN="+c2+"\n")
...
def lect():
 global conta_lect
 x="cOMODIN" + str(conta_lect)
 conta_lect=conta_lect +1
# print(">>>",x)
 iden1.write("\n>>>")
 return x    
...
# lectura Si o No
def lect1():
    sel_ran= random.randint(0,1)
    if sel_ran==0: letra="si"
    else: letra="no"
#    letra="no"
#    print(">",letra)
    return letra
