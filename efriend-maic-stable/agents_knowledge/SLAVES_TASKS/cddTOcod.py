...
def arg_est(t_instr):
   if ( t_instr == 2 or t_instr == 4 or t_instr ==7 or t_instr ==11 or t_instr==9 
...
iden2= open( "MICRO_DIALOGUES_CDD/" + file_name2,"r",encoding="latin-1")
iden1 =open( "MICRO_DIALOGUES_SET/" + file_name1,'w',encoding="latin-1")
